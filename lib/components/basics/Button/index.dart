 ...
 * @LastEditors: zhangle
 * @LastEditTime: 2022-07-10 02:23:59
 */
...
class _ButtonState extends State<Button> {
  ...
  void initState() {
    ...
    if (widget.round == true) { // 如果圆角
      ...
      shape = MaterialStateProperty.all(
        BeveledRectangleBorder( side: BorderSide(
          color: widget.type == 'plain' ? color : backgroundColorA,
          width: 0.5
        ))
      );
    ...
    return Opacity(
      ...
      child: ClipRRect(
        ...
        child: ElevatedButton(
          ...
          style: ButtonStyle(
            minimumSize: MaterialStateProperty.resolveWith<Size>((states) => Size(width, 44) ),
