...
class Toast {
  ...
  static void show (BuildContext context, {String text = '加载中', int duration = 2}) {
    showDialog(
      ...
      child: ClipRRect(
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            color: Color.fromRGBO(0, 0, 0, 0.5) // 背景色
          ),
          child: Column(
            ...
            children: [
              ...
              Container(
                child: Text(text, textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 12.0, decoration: TextDecoration.none),),
              )
            ],
          ),
        ),
